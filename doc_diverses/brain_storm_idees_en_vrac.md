...
**********
 ...
 - pas de pièce de 1 : (nombre de pièce) points de style.
 - pas de pièce de 2 : (nombre de pièce) points de style (cumulable avec le "pas de pièces de 1")
 - toutes les pièces pareilles : (nombre de pièce) points de style. (Achievement avec ça. Sur les différentes valeurs de pièces. + de 10 pièces, + de 20 pièces, ...)
 - sélection en un seul chemin, tracé en une fois. (Le joueur doit vraiment le tracer lui-même) : (nombre de pièce) points de style
...
faire une sélection avec uniquement X pièces de 1
faire une sélection avec uniquement X pièces de 2
...
**********
boissons possibles (faudra augmenter les prix, dans l'ensemble. J'ai un peu essayé, c'est super facile, là. 
**********
gobelet d'eau : 2
café : 12
café au lait : 15
...
**********
augmentation difficulté en fonction du niveau / du temps de jeu
**********
...
Et des post-it ? Faut des post-it sur l'aire de jeu.
