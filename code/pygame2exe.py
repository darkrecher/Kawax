"""
Transformation en executable du jeu Kawax.

Fait par Recher
Repo : https://github.com/darkrecher/Kawax

Source du fichier : tutoriel de pygame.
...
class BuildExe:
    def __init__(self):
        ...
        self.license = "Free Art License : http://www.artlibre.org or CC-BY"

        #Auhor of program
        self.author_name = "Recher"
        self.author_email = "plouf@plouf.com"
        self.copyright = "Copyright (c) 2014 Recher."

        #Description
        self.project_description = "Dis iz Kawax. My game. da bayst in da vvoirld !"

        #Icon file (None will use pygame default icon)
        # Recher : J'arrive pas a foutre des icones.
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ["fontzy", "img", "sound", "readme.txt", "lisezmoi.txt"]

        #Extra/excludes python modules
        self.extra_modules = ["pygame.font"] #Recher : osef ?
